...
export const LoginForm = ({ showModal, setShowModal,setSelectedHomeModal }) => {
    ...
    const [checkBoxState,setCheckBoxState] = React.useState([
        {
            label: "Keep me signed in", value: "Keep me signed in", id: uuid(), isChecked: false
        }
    ])
                    ...
                    <LogInForm className="modal">
                        ...
                        <ModalContent>
                            <HeaderLogIn>
                                ...
                                <HeaderLogInClose href="#" ><SVGIcon name="close" width="10px" height="10px" fill="#006c70" onClick= {()=> setShowModal(prev=>!prev)}/></HeaderLogInClose>
                            </HeaderLogIn>
                            <CNButton className= {logInFormStyle.FbBtnStyle}> 
                                <SVGIcon name="facebook" width="15px" height="15px" fill="#506dab" className= {logInFormStyle.IconFbStyle} />
                                 Login with Facebook
                            </CNButton>
                            ...
                            <CNTextField 
                                ...
                                endAdornment={<SVGIcon name="user" width="15px" height="15px" fill="#006c70" className= {logInFormStyle.iconTextFieldStyle} />}
                                >
                            </CNTextField>
                            <CNTextField 
                            type="password" 
                            ...
                            <UnderTextField>
                                <CheckboxForm>
                                    ...
                                    ></CNCheckBox>
                                    <span className={logInFormStyle.textCheckBox}>Keep me signed in</span>
                                </CheckboxForm>
                                <a href="#" >Lost Your Password?</a>

                            </UnderTextField>    

                            <CNButton type="main" className={logInFormStyle.buttonLogInStyle} >Login</CNButton>
